...
def preprocess_qwen_2_visual(
    ...
    # --- Add the following two lines to provide default values for None ---
    grid_thw_image = grid_thw_image if grid_thw_image is not None else []
    grid_thw_video = grid_thw_video if grid_thw_video is not None else []
    # --- Modification ends ---
